...
const { testing, errorLog, infoLog, inform } = require('./utils/log');
/**
 * @author Ty Foster
 * @version 2020.09.24
 * @summary main file for running _mombot application
 */
...
/**
 * @summary notify that bot has started running
 */
client.on('ready', () => {
    testing(false);
...
/**
 * @summary Listener for message event, handles ignoring or interpreting message
 * @param {Message} message a Message from a discord Guild Channel
 */
